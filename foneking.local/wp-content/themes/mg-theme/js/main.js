...
/* harmony import */ var _import_modules_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1);
/* harmony import */ var _import_components_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(16);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _modules_header_header_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(2);
...
/* harmony import */ var _modules_footer_footer_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(3);
/* harmony import */ var _modules_main_main_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(5);
/* harmony import */ var _modules_pay_form_pay_form_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(14);
/* harmony import */ var _modules_pay_form_pay_form_js__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_modules_pay_form_pay_form_js__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _modules_address_form_address_form_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(15);
/* harmony import */ var _modules_address_form_address_form_js__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_modules_address_form_address_form_js__WEBPACK_IMPORTED_MODULE_4__);


 // import "%modules%/payment-form/payment-form.js";
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var tingle_tingle__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(4);
/* harmony import */ var tingle_tingle__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(tingle_tingle__WEBPACK_IMPORTED_MODULE_0__);
 // FAQ

var faqTriger = document.querySelector('#faq-triger');
var faqLay = document.querySelector('.top-row__faq-lay');
faqTriger.addEventListener('click', function (e) {
  e.preventDefault();
  faqLay.classList.toggle('opened');

  if (faqLay.classList.contains('opened')) {
...
var modalTrigers = [].slice.call(document.querySelectorAll('.modal-triger'));

for (var i = 0; i < modalTrigers.length; ++i) {
  modalTrigers[i].addEventListener('click', showModalLogic);
}

function showModalLogic(e) {
  e.preventDefault();
  var target = e.target;
  var href = target.getAttribute('href');
  new tingle_tingle__WEBPACK_IMPORTED_MODULE_0___default.a.modal({
    footer: false,
    stickyFooter: false,
  ...
  }).setContent(document.querySelector(href).innerHTML).open();
}
/*
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var gsap_TweenLite__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(6);
/* harmony import */ var gsap_ScrollToPlugin__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(9);
/* harmony import */ var just_validate_dist_js_just_validate__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(10);
...
function init() {
  // scroll btn
  var scrollsBts = [].slice.call(document.querySelectorAll('.scroll-btn'));

  for (var i = 0; i < scrollsBts.length; ++i) {
    scrollsBts[i].addEventListener('click', function (e) {
      e.preventDefault();
  ...
  /*#__PURE__*/
  function () {
    function Gallery(wrap, options) {
      _classCallCheck(this, Gallery);

      this.gall = document.querySelector(wrap);
      this.gallPrevImgList = this.gall.querySelector('.gallery-col__prev-list');
      this.bigImgContainer = this.gall.querySelector('.gallery-col__main-img'); // init
    ...
    _createClass(Gallery, [{
      ...
      value: function _init() {
        this.gallPrevImgList.addEventListener('click', this._changeImg.bind(this));
      }
    }, {
      key: "_changeImg",
      value: function _changeImg(e) {
        if (!this._checkTrigerImg(e)) return;
        var bigImgLink = e.target.getAttribute('data-src');
        this.bigImgContainer.setAttribute('src', bigImgLink);
      }
    }, {
      key: "_checkTrigerImg",
      value: function _checkTrigerImg(e) {
        var target = e.target;
  ...
  window.prod = {
    actualProdId: null,
    actualProductInfo: null,
    actualAddress: null
  };

  function clearSteps(sectionsSellectors) {
    for (var _i = 0; _i < sectionsSellectors.length; ++_i) {
      // console.log([].slice.call(document.querySelectorAll(sectionsSellectors[i])))
      var elements = [].slice.call(document.querySelectorAll(sectionsSellectors[_i]));

      for (var e = 0; e < elements.length; ++e) {
        if (elements[e].classList.contains('opened')) {
          elements[e].classList.remove('opened');
        }
      }
    }
  } // step #1
  ...
  var specialOfferSection = document.querySelector('.s-offer-section');
  var btnTrigerList = [].slice.call(document.querySelectorAll('a[data-step="1"]'));

  for (var _i2 = 0; _i2 < btnTrigerList.length; ++_i2) {
    btnTrigerList[_i2].addEventListener('click', setProductIdOnFirstStep);
  }
  ...
  function setProductIdOnFirstStep(e) {
    ...
    clearSteps(['.s-offer-section', '.form-section', '.payment-section']);

    $('input[type="checkbox"]').prop('checked', false);
    $(this).find('input[type="checkbox"]').prop('checked', true);

    if (e.currentTarget.hasAttribute('data-product-id')) {
      var prodId = e.currentTarget.getAttribute('data-product-id');
      window.prod.actualProdId = prodId;
      sectionOpenLogicOnFirstStep(); // if(!window.products) {
      //     fetch('products.json')
      //     .then(res=>{
      //         return res.json();
      //     })
      //     .then(data=>{
      //         window.products = data.prod;
      //     })
      //     .catch(()=>{
      //         alert('This product not founded. Please, choose another product')
      //     })
      // } else {
      //     sectionOpenLogicOnFirstStep();
      // }
    } else {
      alert('This product not founded. Please, choose another product');
    }
  ...
  function sectionOpenLogicOnFirstStep() {
    if (document.querySelector("[data-product-id=\"".concat(window.prod.actualProdId, "\"]")).hasAttribute('data-product-canbesubscribed')) {
      openSpecialOffer();
    } else {
      renderOrderList();
      openAddressForm();
  ...
  function openSpecialOffer() {
    if (specialOfferSection.classList.contains('opened')) {
      gsap_TweenLite__WEBPACK_IMPORTED_MODULE_0__["default"].to(window, 1, {
        scrollTo: specialOfferSection
      });
      return;
    }
    ...
    var handler = function handler() {
      ...
      specialOfferSection.removeEventListener('transitionend', handler);
    };

    specialOfferSection.addEventListener('transitionend', handler);
    specialOfferSection.classList.add('opened');
  } // step #2


  var formSection = document.querySelector('.form-section');
  var subscrBtnRow = document.querySelector('#subscribe-btns');
  var btnTrigerList2 = [].slice.call(document.querySelectorAll('a[data-step="2"]'));

  for (var _i3 = 0; _i3 < btnTrigerList2.length; ++_i3) {
    btnTrigerList2[_i3].addEventListener('click', setProductIdOnSecondStep);
  }

  function setProductIdOnSecondStep(e) {
    e.preventDefault(); // trackers
    ...
    var target = e.target;
    var isChooseSubscribe = null;

    if (target.hasAttribute('data-answer')) {
      var answer = target.getAttribute('data-answer');
      isChooseSubscribe = answer === 'yes' ? true : false;
    } else {
      isChooseSubscribe = false;
    }

    if (isChooseSubscribe && target.hasAttribute('data-product-id')) {
      var prodId = target.getAttribute('data-product-id');
      window.prod.actualProdId = prodId;
    }
  ...
  function renderOrderList() {
    var listContainer = document.querySelector('.cart-list');
    ...
    var actualProdInfo = {};
    var dataEl = document.querySelector("[data-product-id=\"".concat(window.prod.actualProdId, "\"]"));
    var totalBlock = document.querySelector('.total-block'); // shipping

    var shippingBlock = totalBlock.querySelector('[data-shipping]'); // total price

    var priceBlock = totalBlock.querySelector('[data-total]'); // itemTemplate

    var cartItem = document.querySelector('#cart-item');
    var clone = cartItem.content.cloneNode(true); // set img
    // let img = document.querySelector(`[data-product-id=${window.prod.cart.package.id}] img`).getAttribute('src');

    var img = dataEl.getAttribute('data-product-cartimg');
    clone.querySelector('img').setAttribute("src", img);
    clone.querySelector('img').setAttribute("alt", 'zense-img');
    actualProdInfo.cartimg = img; // set dscr

    var dscr = dataEl.getAttribute('data-product-name');
    clone.querySelector('[data-dscr]').innerHTML = dscr;
    actualProdInfo.name = dscr; // set price

    var price = dataEl.getAttribute('data-product-price');
    clone.querySelector('[data-price]').innerHTML = dataEl.hasAttribute('data-product-issubscribe') ? "$".concat(price, "/month") : "$".concat(price);
    listContainer.appendChild(clone);
    actualProdInfo.price = +price; // set shipping price

    var shippingPrice = dataEl.hasAttribute('data-product-shipping') ? dataEl.getAttribute('data-product-shipping') : 0;
    shippingBlock.innerHTML = shippingPrice ? "$".concat(shippingPrice) : "FREE";
    actualProdInfo.shipping = +shippingPrice; // set total

    var total = shippingPrice ? +shippingPrice + +price : price;
    priceBlock.innerHTML = "$".concat(total);
    actualProdInfo.total = +total; // set isSubscrInfo

    dataEl.hasAttribute('data-product-issubscribe') ? actualProdInfo.issubscribe = true : false; // set product Info -> window

    window.prod.actualProductInfo = actualProdInfo; // setPayPalBtn()
  }
  ...
  function openAddressForm(e) {
    ...
    var handler = function handler() {
      ...
      formSection.removeEventListener('transitionend', handler);
    };

    if (specialOfferSection.classList.contains('opened')) {
      specialOfferSection.classList.remove('opened');
    }

    formSection.addEventListener('transitionend', handler);
    formSection.classList.add('opened');
  } // step #3 (open checkout trigers)


  var paySection = document.querySelector('.payment-section');
  var submitAddressBtn = document.querySelector('#address-form');
  document.querySelector('#country').addEventListener('input', function () {
    paySection.classList.remove('opened');
  });
  submitAddressBtn.addEventListener('submit', function (e) {
    e.preventDefault();
  ...
  function saveFormData(form) {
    ...
    for (var _i4 = 0; _i4 < form.elements.length; ++_i4) {
      if (!form.elements[_i4].hasAttribute('name')) continue;
      dataObj[form.elements[_i4].getAttribute('name')] = form.elements[_i4].value;
    }

    window.prod.actualAddress = dataObj;

        resultForm.name = dataObj['first-name']+' '+dataObj['last-name'];
        resultForm.email = dataObj['email'];
        resultForm.phone = dataObj['phone'];
        resultForm.address = dataObj['country']+', '+dataObj['state']+', '+dataObj['city']+', '+dataObj['line1']+', '+dataObj['line2']+', '+dataObj['zip'];
        resultForm.price = document.querySelector('[data-total]').innerHTML;
        resultForm.product = document.querySelector('[data-dscr]').innerHTML;
  ...
  function openPay() {
    ...
    clearSteps(['.form-section']);

    var handler = function handler() {
      gsap_TweenLite__WEBPACK_IMPORTED_MODULE_0__["default"].to(window, 1, {
        scrollTo: paySection
      });
      paySection.removeEventListener('transitionend', handler);
    };

    paySection.addEventListener('transitionend', handler);
    paySection.classList.add('opened');

        resultForm.status = 'Pending payment';
        $.ajax({
          type:"POST",
  ...
  function validate(obj) {
    ...
    for (var key in obj) {
      reqString += "&".concat(key, "=").concat(obj[key]);
    }

    console.log(reqString);
    fetch("https://us-zipcode.api.smartystreets.com/lookup?auth-id=20874905061357481".concat(reqString)).then(function (res) {
      return res.json();
    }).then(function (data) {
      var info = data[0];
      ...
      if (info.status) {
        switch (info.status) {
          case "blank":
            alert("Blank lookup (you must provide a ZIP Code and/or City/State combination).");
            setInvalidOutput(['#city', '#state', '#zip']);
            return false;

          case "invalid_state":
            alert("Invalid State name or abbreviation.");
            setInvalidOutput(['#state']);
            return false;

          case "invalid_city":
            alert("Invalid City for the given State.");
            setInvalidOutput(['#city']);
            return false;

          case "invalid_zipcode":
            alert("Invalid ZIP Code.");
            setInvalidOutput(['#zip']);
            return false;

          case "conflict":
            alert("Conflicting ZIP Code/City/State information.");
            setInvalidOutput(['#city', '#state', '#zip']);
            return false;
        }
      }
  ...
  function setInvalidOutput(arr) {
    var _loop = function _loop(_i5) {
      var el = document.querySelector(arr[_i5]);
      el.parentElement.classList.add('fail');

      var removeFail = function removeFail() {
        el.parentElement.classList.remove('fail');
        el.removeEventListener('focus', removeFail);
      };

      el.addEventListener('focus', removeFail);
    };
...
/* harmony import */ var _TweenLite_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(6);
/*!
 * VERSION: 1.9.2
 * DATE: 2019-02-07
 * UPDATES AND DOCS AT: http://greensock.com
...
paypal.Button.render({
  ...
  env: 'production',
  client: {
    production: 'ATwlSn3HULkHZkyY3rGYu3oJFg9CKXVctpbJ8aE1z-GoNskYbBFUAjdKwxwe44s7XJy1BBgbfKIThSMH'
  },
  // Customize button
  locale: 'en_US',
  style: {
  ...
  payment: function payment(data, actions) {
    ...
    if (window.prod.actualProductInfo.issubscribe) {
      // subscribe
      return actions.request.post('./php/subscribe/createPlan.php', {
        productId: window.prod.actualProdId,
        addressInfo: JSON.stringify(window.prod.actualAddress),
        productInfo: JSON.stringify(window.prod.actualProductInfo)
      }).then(function (res) {
        console.log();
        return actions.request.post('./php/subscribe/createAgreement.php', {
          planId: res.id,
          addressInfo: JSON.stringify(window.prod.actualAddress),
          productInfo: JSON.stringify(window.prod.actualProductInfo)
        }).then(function (data) {
          var token = data.slice(data.indexOf('&token=EC-') + 7);
          // console.log(token);
          // console.log(data);
          return token;
        }).catch(function () {
          alert('Sorry! Something wrong happened. Subscription failed. Try to check your shipping information');
        });
      });
    } else {
      // just pay
      return actions.request.post('./php/payment/paymentCreate.php', {
        productId: window.prod.actualProdId,
        addressInfo: JSON.stringify(window.prod.actualAddress),
        productInfo: JSON.stringify(window.prod.actualProductInfo)
      }).then(function (res) {
        ...
        alert('Sorry! Something wrong happened. Payment failed. Try to check your shipping information');
      });
    }
  },
  // Execute the payment:
  ...
  onAuthorize: function onAuthorize(data, actions) {
    if (window.prod.actualProductInfo.issubscribe) {
      return actions.request.post("./php/subscribe/confirmAgreement.php", {
        token: data.orderID,
        productId: window.actualProdId,
        addressInfo: JSON.stringify(window.prod.actualAddress),
        productInfo: JSON.stringify(window.prod.actualProductInfo)
      }).then(function (res) {
        if (res.state === "Pending" || res.state === "Active") {
        ...
        dataLayer.push({
          ...
          'ecommerce': {
            'purchase': {
              ...
              'products': [{
                'name': window.prod.actualProductInfo.name,
                'price': window.prod.actualProductInfo.price
               }
              ]
            }
          }
          ...
          alert('Thank you! Subscription was successful');
          return res;
        }
      }).then(function (res) {
        ...
        resultForm.payment = res.payer['payment_method'];
        resultForm.status = 'Waiting processing';
        console.log(resultForm);
        ...
        $.ajax({
          ...
          url: baseUrl+"/wp-admin/admin-ajax.php",
          data: {
            action: 'updatePostPaymentStatus',
            dataObj: resultForm,
          },
          beforeSend: function(xhr, textStatus){
            console.log('Ajax GO');
        ...
        resultForm.status = 'Payment failed';
        console.log(resultForm);
      ...
      // just pay
      return actions.request.post('./php/payment/execute.php', {
  ...
  onCancel: function onCancel(data, actions) {
    alert("Your Payment Has NOT Been Processed. \n\r Have a question or encountering a problem? Feel free to chat with our customer experience team with the live chat button in the bottom right corner.");
  }
}, '#pay-trigers');
...
fetch('https://restcountries.eu/rest/v2/all?fields=name;alpha2Code').then(function (res) {
  return res.json();
}).then(function (data) {
  for (var i = 0; i < data.length; ++i) {
    ...
    if (data[i].alpha2Code == "US") option.setAttribute('selected', 'selected');
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _blocks_components_feedback_feedback_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(17);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var gsap__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(18);
/* harmony import */ var scrollmagic_scrollmagic_uncompressed_ScrollMagic__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(29);
...
/* harmony import */ var imports_loader_define_false_scrollmagic_scrollmagic_uncompressed_plugins_animation_gsap__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(30);
...
/* harmony import */ var beerslider__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(31);
/* harmony import */ var beerslider__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(beerslider__WEBPACK_IMPORTED_MODULE_3__);
...
var controller = new scrollmagic_scrollmagic_uncompressed_ScrollMagic__WEBPACK_IMPORTED_MODULE_1___default.a.Controller();
var scenes = [];
var activeScenes = []; // BA slider

var slidersList = [].slice.call(document.querySelectorAll('.feedback:not(.noslider) .beer-slider'));

var _loop = function _loop(i) {
  var sliderEl = new beerslider__WEBPACK_IMPORTED_MODULE_3___default.a(slidersList[i], {
    start: 1
  });
  scenes.push(function () {
    var tween = new gsap__WEBPACK_IMPORTED_MODULE_0__["TimelineMax"]().to(slidersList[i].querySelector('.beer-reveal'), 0.7, {
      width: '50%',
      ease: Back.easeOut.config(1.7)
    }).to(slidersList[i].querySelector('.beer-handle'), 0.7, {
      left: '50%',
      ease: Back.easeOut.config(1.7)
    }, 0).to(slidersList[i].querySelector('.beer-range'), 0.7, {
      attr: {
        'aria-valuenow': 50,
        value: 50
      },
    ...
    return new scrollmagic_scrollmagic_uncompressed_ScrollMagic__WEBPACK_IMPORTED_MODULE_1___default.a.Scene({
...
function addScenes(newScenes) {
  // reset active scenes
  activeScenes = []; // loop over each scene and add/re-add

  newScenes.forEach(function (newScene, index) {
    if (typeof newScene === 'function') {
      // add the new scene
      var newS = newScene(); // push it to our active scenes array
...
/* harmony import */ var _TimelineLite_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(19);
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "TimelineLite", function() { return _TimelineLite_js__WEBPACK_IMPORTED_MODULE_1__["default"]; });

/* harmony import */ var _TimelineMax_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(20);
...
/* harmony import */ var _TweenMax_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(21);
...
/* harmony import */ var _CSSPlugin_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(23);
...
/* harmony import */ var _AttrPlugin_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(24);
...
/* harmony import */ var _RoundPropsPlugin_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(25);
...
/* harmony import */ var _DirectionalRotationPlugin_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(26);
...
/* harmony import */ var _BezierPlugin_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(27);
...
/* harmony import */ var _EasePack_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(28);
...
/* harmony import */ var _TweenMaxBase_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(22);
/* harmony import */ var _CSSPlugin_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(23);
...
/* harmony import */ var _AttrPlugin_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(24);
...
/* harmony import */ var _RoundPropsPlugin_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(25);
...
/* harmony import */ var _DirectionalRotationPlugin_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(26);
...
/* harmony import */ var _TimelineLite_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(19);
...
/* harmony import */ var _TimelineMax_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(20);
...
(function (root, factory) {
	if (typeof define === 'function' && define.amd) {
		...
		factory(__webpack_require__(29), TweenMax, TimelineMax);
	} else {}
