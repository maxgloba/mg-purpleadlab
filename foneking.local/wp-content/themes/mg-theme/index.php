                ...
                <div class="form-lay">
                  ...
                  <form id="address-form">
                    ...
                    <div class="row">
                      ...
                      <div class="field half-width">
                        <input class="input empty" id="phone" type="tel" placeholder="Phone number" name="phone" required="">
                        <label for="phone">Phone number</label>
                      </div>
                    </div>
                    <div class="row">
                      <div class="field third-width">
                        <input class="input empty" id="address" type="text" placeholder="Address" required="" name="line1" maxlength="50">
                        <label for="address">Address</label>
                      </div>
                      <div class="field quarter-width">
                        <input class="input empty" id="apt" type="text" placeholder="Apt/Suite" name="line2" maxlength="10">
                    ...
                    <div class="row" data-locale-reversible>
                      ...
                      <div class="field quarter-width">
                        <input class="input empty" id="zip" type="text" placeholder="ZIP" required="" name="zip" maxlength="10">
