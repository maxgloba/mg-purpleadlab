...
function addPost(){
	...
	$c1_list_array = $formdata['c1_list'];
	$c2_list_array = $formdata['c2_list'];
	$c3_list_array = $formdata['c3_list'];
	$c4_list_array = $formdata['c4_list'];
		...
		foreach( $quiz_datas as $data ){
			...
			<div id="quiz-'.$data->id.'" class="quiz-box">
				...
				<div class="quiz-content">
					...
					<div class="mg_shop_phone"><span class="label">Phone:</span> '.$data->phone.'</div>
