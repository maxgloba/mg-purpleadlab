...
let next = document.getElementById('c1-1');
...
let cancel = document.getElementById('c1-2');
cancel.onclick = () => {
  mySwiper.slidePrev();
}
...
let socialItem = document.getElementsByClassName('social-input');
let socialSubmit = document.getElementById('socialSubmit');

// socialSubmit.onclick = () => {
//   mySwiper.slideNext();
// }

socialSubmit.addEventListener('click', function(e) {
    e.preventDefault();
  mySwiper.slideNext();
  return false;
})
...
for(let i = 0; i < socialItem.length; i++) {
  socialItem[i].addEventListener('click', function(e) {
    let flag = false;

    for(let i = 0; i < socialItem.length; i++) {
      if(socialItem[i].checked) {
        flag = true;
      }
    }

    if(flag) {
      socialSubmit.style.display = 'block';
    } else {
      socialSubmit.style.display = 'none';
    }
  });
}


let textItem = document.getElementsByClassName('text-input');

for(let i = 0; i < textItem.length; i++) {
  textItem[i].addEventListener('click', function(e) {
    mySwiper.slideNext();
  })
}

let advertiseItem = document.getElementsByClassName('advertise-input');
let advertise = document.getElementsByClassName('advertise-item');
let advertiseBtn = document.getElementById('advertiseSubmit');
...
advertiseBtn.addEventListener('click', function(e) {
  ...
  for(let i = 0; i < advertiseItem.length; i++) {

    if(advertiseItem[i].checked) {
      flag = true;
    }
  }
  ...
  if(flag) {
    ...
    for(let i = 0; i < advertise.length; i++) {
      advertise[i].classList.add('border');

      setInterval(function() {
        advertise[i].classList.remove('border');
      }, 1000);
    }
  }
...
// Implement line animation on canvas
