	...
	<div id="mwb_upsell_lite_overview_pro_version">
		...
		<div class="mwb_upsell_overview_supported_product">
			...
			<div class="mwb_upsell_overview_simple_product_icon">
				<img src="<?php echo MWB_WOCUF_URL . "admin/resources/simple-product.png"; ?>">
				<h4><?php esc_html_e( 'Simple Products', 'woocommerce_one_click_upsell_funnel' ); ?></h4>
			</div>

			<div class="mwb_upsell_overview_simple_product_icon">
				<img src="<?php echo MWB_WOCUF_URL . "admin/resources/variable-product.png"; ?>">
		...
		<div class="mwb_upsell_overview_go_pro">
			...
			<a class="button mwb_upsell_overview_go_pro_button" target="_blank" href="https://makewebbetter.com/product/woocommerce-one-click-upsell-funnel-pro/?utm_source=MWB-upsell-org&utm_medium=Overview&utm_campaign=ORG"><?php esc_html_e( 'Upgrade to Premium &rarr;', 'woocommerce_one_click_upsell_funnel' ); ?></a>
		</div>
