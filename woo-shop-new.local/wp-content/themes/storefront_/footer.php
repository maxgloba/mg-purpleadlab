...
?>
			...
			<footer class="main-footer">
				...
				<div class="main-footer__bottom-row">
					...
					<?php if( have_rows('footer_menu', 5) ): ?>
					<nav class="main-footer__main-nav">
						<ul class="main-footer__main-nav-list">
							<?php while ( have_rows('footer_menu', 5) ) : the_row(); ?>
								<li class="main-footer__main-nav-item"><a class="main-footer__main-nav-link text modal-triger" href="#template_<?php the_sub_field('name', 5); ?>"><?php the_sub_field('name', 5); ?></a></li>
							<?php endwhile; ?>
						</ul>
					</nav>
					<?php endif; ?>
			...
			<?php if( have_rows('footer_menu', 5) ): ?>
				<?php while ( have_rows('footer_menu', 5) ) : the_row(); ?>
					<template id="template_<?php the_sub_field('name', 5); ?>">
