...
class translator
{
    ...
    public function __construct()
    {
		...
		$this->add( 'tiptip.update-cart-contents-disable-scroll', __( 'This option disables scroll to checkout.', 'woocommerce-one-page-shopping' ) );
		...
		$this->add( 'label.update-cart-contents-disable-scroll', __( 'Disable scroll to checkout', 'woocommerce-one-page-shopping' ) );
