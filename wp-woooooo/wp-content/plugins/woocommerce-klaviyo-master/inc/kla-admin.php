...
class WPKlaviyoAdmin {
    ...
    function settings() {
        ...
        $content .= '</table>';
        $content .= '<p>This will automatically install the Klaviyo script needed for signup forms. Learn more about Klaviyo <a href="https://help.klaviyo.com/hc/en-us/articles/360002035871-Install-Klaviyo-Signup-Forms#verify-your-installation">Signup forms.</a></p>';
