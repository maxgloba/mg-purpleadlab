...
function wc_format_sale_price( $regular_price, $sale_price ) {
	...
	$save_p = 100 - ($sale_price*100/$regular_price);
	$price = '
	<div class="text old-price m-spacer">' . ( is_numeric( $regular_price ) ? wc_price( $regular_price ) : $regular_price ) . '</div>
	<div class="text bold big">' . ( is_numeric( $sale_price ) ? wc_price( $sale_price ) : $sale_price ) . '</div>
	<div class="text new-price">You save: $'. $save .' USD('. round($save_p,2) .'%)</div>
	';
