...
<div class="wrap woocommerce" id="mwb_wocuf_pro_setting_wrapper">
    ...
    <div class="mwb_wocuf_pro_header">
    	<h1 class="mwb_wocuf_pro_setting_title"><?php esc_html_e( 'WooCommerce One Click Upsell Funnel', 'woocommerce_one_click_upsell_funnel' )?>
        
        </h1>

        <div id="mwb_upsell_skype_connect_with_us">   
            <h2><?php esc_html_e( 'Connect with Us in one click', 'woocommerce_one_click_upsell_funnel' )?></h2>
